...
3. name: list_directory
   description: Lists all files and folders in a directory.
   arguments: The path to the directory (e.g. "." for current directory).
...
if __name__ == "__main__":
    # Let's create the starting file so the agent has something to do
    with open("secret_message_for_agent.txt", "w") as f:
        f.write("You rock! You successfully built a fully functioning autonomous agent!")
        
    print("\n========================================")
    print(" EXERCISE 3: AUTONOMOUS AGENT (SOLUTION)")
    print("========================================")
    ...
    print("Try asking it: 'List the files in the directory. Find the file that ends with .txt and starts with secret, read it, then finish and tell me the contents.'")
